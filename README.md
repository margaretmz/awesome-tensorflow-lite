...
| Object detection                | MobileDet                                    | [Paper](https://arxiv.org/abs/2004.14525) \| [Blog post showing (includes model conversion process)](https://sayak.dev/mobiledet-optimization/)                                                                                                                                                                                                                                                                                                  | Paper from   University of Wisconsin-Madison & Google, Blog post by community        |
...
| Text detection   | EAST                                                    | [Models on TF Hub with Colab Notebook](https://tfhub.dev/sayakpaul/lite-model/east-text-detector/dr/1)  \| [Blog post](https://sayak.dev/optimizing-text-detectors/)                                                                                                                          | Community          |
